...
public:
    ...
    {
        createSimpleCalibrationDialog->setWindowTitle(QApplication::translate("createSimpleCalibrationDialog", "Create simple calibration", 0, QApplication::UnicodeUTF8));
        comboBox_advanced->clear();
        comboBox_advanced->insertItems(0, QStringList()
         << QApplication::translate("createSimpleCalibrationDialog", "Basic (images are already rectified)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("createSimpleCalibrationDialog", "Advanced (images should be rectified)", 0, QApplication::UnicodeUTF8)
        );
        checkBox_stereo->setText(QApplication::translate("createSimpleCalibrationDialog", "Stereo", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Camera Intrinsics", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("createSimpleCalibrationDialog", "fy", 0, QApplication::UnicodeUTF8));
        label_baseline->setText(QApplication::translate("createSimpleCalibrationDialog", "baseline (m)", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("createSimpleCalibrationDialog", "cx", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("createSimpleCalibrationDialog", "cy", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("createSimpleCalibrationDialog", "fx", 0, QApplication::UnicodeUTF8));
        groupBox_3->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Camera Intrinsics", 0, QApplication::UnicodeUTF8));
        label_left->setText(QApplication::translate("createSimpleCalibrationDialog", "Left", 0, QApplication::UnicodeUTF8));
        label_right->setText(QApplication::translate("createSimpleCalibrationDialog", "Right", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("createSimpleCalibrationDialog", "fx", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("createSimpleCalibrationDialog", "fy", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("createSimpleCalibrationDialog", "cy", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        label_12->setToolTip(QApplication::translate("createSimpleCalibrationDialog", "k1, k2, p1, p2[, k3[, k4, k5, k6 ]]", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_12->setText(QApplication::translate("createSimpleCalibrationDialog", "Distorsion coefficients (4, 5 or 8 values)", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("createSimpleCalibrationDialog", "cx", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Image Size", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("createSimpleCalibrationDialog", "Image width", 0, QApplication::UnicodeUTF8));
        label_13->setText(QApplication::translate("createSimpleCalibrationDialog", "Image height", 0, QApplication::UnicodeUTF8));
        groupBox_stereo_extrinsics->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Stereo Camera Extrinsics", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_6->setText(QApplication::translate("createSimpleCalibrationDialog", "Transform between the cameras", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
