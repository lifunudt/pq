...
public:
    ...
    void setupUi(QDialog *calibrationDialog)
    {
        ...
        calibrationDialog->resize(1314, 860);
        ...
        checkBox_unlock = new QCheckBox(calibrationDialog);
    ...
    void retranslateUi(QDialog *calibrationDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        label_22->setToolTip(QApplication::translate("calibrationDialog", "Number of inner squares on the board", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_22->setText(QApplication::translate("calibrationDialog", "Max scale", 0, QApplication::UnicodeUTF8));
        ...
        checkBox_unlock->setText(QApplication::translate("calibrationDialog", "Unlock", 0, QApplication::UnicodeUTF8));
