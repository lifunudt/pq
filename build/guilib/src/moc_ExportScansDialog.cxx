...
#include "../../../guilib/src/ExportScansDialog.h"
...
static const char qt_meta_stringdata_rtabmap__ExportScansDialog[] = {
    "rtabmap::ExportScansDialog\0\0configChanged()\0"
    "restoreDefaults()\0"
};
...
const QMetaObjectExtraData rtabmap::ExportScansDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap::ExportScansDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rtabmap__ExportScansDialog,
      qt_meta_data_rtabmap__ExportScansDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap::ExportScansDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__ExportScansDialog))
